        ...
        <div class="right_col" role="main">
          <!-- top tiles -->
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-building"></i> Mis empresas</span>
              <div class="count">
                <?php
                  $criteria = new CDbCriteria();
                  $criteria->condition = 'idusuario='.Yii::app()->user->id;
                  $count = Empredirector::model()->count($criteria);
                  echo $count;                  
                ?>
              </div>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-file"></i> Mis informes</span>
              <div class="count">
                <?php
                  $q = 'SELECT count(*) from informe WHERE idempresa in(select idempresa FROM empredirector WHERE idusuario ='.Yii::app()->user->id.')';
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-file-text-o"></i> Mis Test</span>
              <div class="count">
                <?php
                  $q1 = 'SELECT count(*) from test WHERE idusuario ='.Yii::app()->user->id;
                  $cmd1 = Yii::app()->db->createCommand($q1);
                  $num1 = $cmd1->queryScalar();
                  echo $num1;
                ?>
              </div>
            </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <?php if(isset($this->breadcrumbs)):?>
                        <?php $this->widget('zii.widgets.CBreadcrumbs', array(
                          'homeLink'=>CHtml::link('<i class="fa fa-home"></i> Inicio</a>',Array('/administracion/index')),
